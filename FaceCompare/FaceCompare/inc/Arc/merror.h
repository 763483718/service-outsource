...
#define MERR_ASF_EX_BASE_FEATURE_UNSUPPORTED_ON_INIT		(MERR_ASF_EX_BASE+1)			//Engine不支持的检测属性
#define MERR_ASF_EX_BASE_FEATURE_UNINITED					(MERR_ASF_EX_BASE+2)			//需要检测是属性未初始化
#define MERR_ASF_EX_BASE_FEATURE_UNPROCESSED				(MERR_ASF_EX_BASE+3)			//待获取的属性未在process中处理过
#define MERR_ASF_EX_BASE_FEATURE_UNSUPPORTED_ON_PROCESS		(MERR_ASF_EX_BASE+4)			//PROCESS不支持的检测属性，例如FR，有自己独立的处理函数
#define MERR_ASF_EX_BASE_INVALID_IMAGE_INFO					(MERR_ASF_EX_BASE+5)			//无效的输入图像
#define MERR_ASF_EX_BASE_INVALID_FACE_INFO					(MERR_ASF_EX_BASE+6)			//无效的脸部信息

#define MERR_ASF_BASE										0x16000							//人脸比对基础错误类型
#define MERR_ASF_BASE_ACTIVATION_FAIL						(MERR_ASF_BASE+1)				//SDK激活失败,请打开读写权限
#define MERR_ASF_BASE_ALREADY_ACTIVATED						(MERR_ASF_BASE+2)				//SDK已激活
#define MERR_ASF_BASE_NOT_ACTIVATED							(MERR_ASF_BASE+3)				//SDK未激活
#define MERR_ASF_BASE_SCALE_NOT_SUPPORT						(MERR_ASF_BASE+4)				//detectFaceScaleVal 不支持
#define MERR_ASF_BASE_VERION_MISMATCH						(MERR_ASF_BASE+5)				//SDK版本不匹配
#define MERR_ASF_BASE_DEVICE_MISMATCH						(MERR_ASF_BASE+6)				//设备不匹配
#define MERR_ASF_BASE_UNIQUE_IDENTIFIER_MISMATCH			(MERR_ASF_BASE+7)				//唯一标识不匹配
#define MERR_ASF_BASE_PARAM_NULL							(MERR_ASF_BASE+8)				//参数为空
#define MERR_ASF_BASE_SDK_EXPIRED							(MERR_ASF_BASE+9)				//SDK已过期
#define MERR_ASF_BASE_VERSION_NOT_SUPPORT					(MERR_ASF_BASE+10)				//版本不支持
#define MERR_ASF_BASE_SIGN_ERROR					        (MERR_ASF_BASE+11)				//签名错误
#define MERR_ASF_BASE_DATABASE_ERROR					    (MERR_ASF_BASE+12)				//数据库插入错误
#define MERR_ASF_BASE_UNIQUE_CHECKOUT_FAIL					(MERR_ASF_BASE+13)				//唯一标识符校验失败
#define MERR_ASF_BASE_COLOR_SPACE_NOT_SUPPORT				(MERR_ASF_BASE+14)				//颜色空间不支持
#define	MERR_ASF_BASE_IMAGE_WIDTH_HEIGHT_NOT_SUPPORT		(MERR_ASF_BASE+15)				//图片宽高不支持(宽度需被4整除，宽高需大于0)
#define MERR_ASF_BASE_READ_PHONE_STATE_DENIED               (MERR_ASF_BASE+16)				//android.permission.READ_PHONE_STATE权限被拒绝
#define	MERR_ASF_BASE_ACTIVATION_DATA_DESTROYED				(MERR_ASF_BASE+17)				//激活数据被破坏,请删除激活文件，重新进行激活

#define MERR_ASF_NETWORK_BASE								0x17000							//网络错误类型
#define MERR_ASF_NETWORK_BASE_COULDNT_RESOLVE_HOST			(MERR_ASF_NETWORK_BASE+1)		//无法解析主机地址
#define MERR_ASF_NETWORK_BASE_COULDNT_CONNECT_SERVER		(MERR_ASF_NETWORK_BASE+2)		//无法连接服务器
#define MERR_ASF_NETWORK_BASE_CONNECT_TIMEOUT				(MERR_ASF_NETWORK_BASE+3)		//网络连接超时
#define MERR_ASF_NETWORK_BASE_UNKNOWN_ERROR					(MERR_ASF_NETWORK_BASE+4)		//网络未知错误
